...
The AWS Prototyping Development Kit (PDK) itself uses the _monorepo_ package and is a good reference for seeing how a complex, polyglot monorepo can be set up.
...
This section describes how to get started with _monorepo_ construct. For more information, please refer to the developer guides for particular features of this construct.
...
=== "TS"
    ...
    ```bash
    npx projen new --from @aws-prototyping-sdk/monorepo monorepo-ts
    ```
    ...
    const project = new MonorepoTsProject({
      ...
      devDeps: ["@aws-prototyping-sdk/monorepo"],
      name: "ts-bootstrap",
      projenrcTs: true,
...
=== "JAVA"
    ...
    ```bash
    npx projen new --from @aws-prototyping-sdk/monorepo monorepo-java
    ```
...
=== "PYTHON"
    ...
    ```bash
    npx projen new --from @aws-prototyping-sdk/monorepo monorepo-py
    ```
    ...
    project = NxMonorepoPythonProject(
        ...
        dev_deps=["@aws-prototyping-sdk/monorepo"],
    ...
    !!! bug
        ...
        `@aws-prototyping-sdk/monorepo` can be removed from _dev_deps_ as this is erroneously added by Projen due to a bug in their bootstrapping process.
