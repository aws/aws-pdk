...
export class Store implements SerializedGraph.ISerializableGraphStore {
  ...
  static fromSerializedStore(serializedStore: SerializedGraph.SGGraphStore) {
  ...
  implements SerializedGraph.ISerializableEntity
{
  ...
  addTag(key: string, value: string): void {
    if (this.hasTag(key)) {
      throw new Error(
        `Entity ${String(this)} already has tag ${key}; use setTag to override`
      );
    }
  ...
  implements SerializedGraph.ISerializableEdge
{
  ...
  get isClosed(): boolean {
    return this._source === this._target || this.hasFlag(FlagEnum.CLOSED_EDGE);
  }
  ...
  implements SerializedGraph.ISerializableNode
{
   ...
   */
  get isExtraneous(): boolean {
    return this.hasFlag(FlagEnum.EXTRANEOUS) || (this.isCluster && this.isLeaf);
  }
...
export function deserializeStore(
  serializedStore: SerializedGraph.SGGraphStore,
