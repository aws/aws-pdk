...
/**
 * Configuration for the generated typescript react-query hooks library
 */
export interface GeneratedTypescriptReactQueryV5HooksProjectOptions
  extends GeneratedTypeScriptReactQueryV5HooksOptions,
    CodeGenerationSourceOptions {
  /**
 ...
 */
export class TypescriptReactQueryV5HooksLibrary extends TypeScriptProject {
  /**
   ...
   * @private
   */
  private readonly options: GeneratedTypescriptReactQueryV5HooksProjectOptions;

  constructor(options: GeneratedTypescriptReactQueryV5HooksProjectOptions) {
    super({
      ...(options as any),
      sampleCode: false,
      tsconfig: {
    ...
    openapiGeneratorIgnore.addPatterns(
      ...TypescriptReactQueryV5HooksLibrary.openApiIgnorePatterns
    );
  ...
  public buildGenerateCommandArgs = () => {
    return buildInvokeOpenApiGeneratorCommandArgs({
      ...
      generatorDirectory: Library.TYPESCRIPT_REACT_QUERY_V5_HOOKS,
