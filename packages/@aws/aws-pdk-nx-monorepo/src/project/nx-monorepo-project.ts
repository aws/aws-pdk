...
function getPluginPath() {
  const prefix =
    process.env.NODE_ENV === "test"
      ? "."
      : "./node_modules/@aws/aws-pdk-nx-monorepo";
  const pluginDir = fs.existsSync(
    "./node_modules/@aws/aws-pdk-nx-monorepo/lib/"
  )
    ? "lib"
    : "src";
  return `${prefix}/${pluginDir}/project/plugin/nx-monorepo-plugin.js`;
}
