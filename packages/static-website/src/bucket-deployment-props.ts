...
import type { aws_ec2, aws_iam, aws_logs, aws_s3, aws_s3_deployment, Expiration, interfaces, Size } from 'aws-cdk-lib';
...
not specified a dedicated security group will be created for this function.
   ...
   * @stability stable
   */
  readonly distribution?: interfaces.aws_cloudfront.IDistributionRef;
  /**
